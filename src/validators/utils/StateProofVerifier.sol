...
library StateProofVerifier {
    ...
    error StateProofVerifier__verifyBlockHeader_invalidHeaderFieldsLength();
        ...
        returns (BlockHeader memory)
    {
        ...
        if (HEADER_TIMESTAMP_INDEX >= headerFields.length)
            revert StateProofVerifier__verifyBlockHeader_invalidHeaderFieldsLength();
